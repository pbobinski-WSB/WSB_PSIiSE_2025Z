...
model_filename = "imdb_lstm_model.keras"
...
if os.path.exists(model_filename):
    ...
    model_nlp = Sequential([
        # Warstwa Embedding pozostaje identyczna
        Embedding(max_features, 128, input_length=maxlen),
        
        # Zamiast Conv1D, używamy LSTM. 64 to liczba jednostek (neuronów) w warstwie.
        # Dropout i recurrent_dropout to techniki regularyzacji, zapobiegające przeuczeniu.
        # LSTM(64, dropout=0.2, recurrent_dropout=0.2), 
        LSTM(64, dropout=0.2, recurrent_dropout=0.2, return_sequences=True), 
        # ====================================================================
        
        # UWAGA: Teraz po LSTM musimy dodać warstwę, która zagreguje sekwencję
        # do jednego wyniku. GlobalMaxPooling1D jest do tego idealny (tak jak w CNN).
        GlobalMaxPooling1D(),        
        # Warstwa Dense na wyjściu pozostaje identyczna
